...
export const CHECKLISTS: ChecklistDef[] = [
  ...
  {
    id: "ago",
    title: "Preparação para a AGO",
    icon: "📋",
    description: "Assembleia Geral Ordinária anual",
    items: [
      { id: "ago1", text: "Verificar prazo de convocação exigido pela convenção (mínimo 10 dias)", critical: true },
      { id: "ago2", text: "Preparar prestação de contas completa do exercício encerrado", critical: true },
      { id: "ago3", text: "Elaborar previsão orçamentária para o próximo exercício" },
      { id: "ago4", text: "Confirmar se há eleição de síndico ou conselho na pauta" },
      { id: "ago5", text: "Solicitar demonstrativos financeiros assinados pela administradora" },
      { id: "ago6", text: "Enviar convocação com pauta detalhada e documentos anexos", critical: true },
      { id: "ago7", text: "Afixar convocação em local visível no condomínio" },
      { id: "ago8", text: "Preparar lista de presença e modelo de procuração" },
      { id: "ago9", text: "Designar secretário para redação da ata na assembleia" },
      { id: "ago10", text: "Registrar ata com votações e encaminhar ao cartório se necessário", critical: true },
    ],
  },
  {
    id: "encerramento-mandato",
    title: "Encerramento de mandato",
    icon: "🗳️",
    description: "Ao concluir a gestão como síndico",
    items: [
      { id: "em1", text: "Preparar relatório final de gestão com resumo das ações do mandato" },
      { id: "em2", text: "Organizar pasta de contratos vigentes (administradora, fornecedores, seguros)" },
      { id: "em3", text: "Listar inadimplências em aberto e acordos parcelados firmados" },
      { id: "em4", text: "Atualizar cadastro de funcionários e situação de benefícios" },
      { id: "em5", text: "Verificar datas de vencimento de AVCB, seguro e licenças críticas", critical: true },
      { id: "em6", text: "Realizar prestação de contas final em assembleia", critical: true },
      { id: "em7", text: "Transferir documentos físicos e digitais ao síndico entrante", critical: true },
      { id: "em8", text: "Atualizar o CNPJ do condomínio com dados do novo síndico", critical: true },
      { id: "em9", text: "Comunicar administradora e fornecedores sobre a troca de gestão" },
      { id: "em10", text: "Arquivar atas, balancetes e documentos contábeis do mandato" },
    ],
  },
];
