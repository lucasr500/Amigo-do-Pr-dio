...
const FLAG_DEFAULTS = {
  ...
  cloud_backup_enabled:     true,   // Backup manual em nuvem (requer auth_enabled + conta)
  sync_enabled:             false,  // Auto-sync contínuo — desativado por padrão
  auth_enabled:             true,   // Login/conta via magic link — ativo
